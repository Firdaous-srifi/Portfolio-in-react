    ...
    <div className='p-4 lg:p-20 flex flex-col items-center justify-center'>
      ...
      <form action="" className='flex flex-col gap-2 lg:w-1/2'>
        <div className='lg:flex gap-9'>
          ...
          <input name="email" placeholder='Enter Your Email' className='w-full lg:my-3 my-4 rounded-lg bg-slate-800 p-4 border-2 border-fuchsia-800 bg-glow text-xl text-slate-500'/>
        </div>
